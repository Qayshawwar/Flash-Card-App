...
router.patch('/:flashcardId', FlashcardController.update.bind(FlashcardController));

// FR-03: POST   /api/v1/collections/:collectionId/flashcards/:flashcardId/duplicate
router.post('/:flashcardId/duplicate', FlashcardController.duplicate.bind(FlashcardController));

// FR-11: PATCH  /api/v1/collections/:collectionId/flashcards/:flashcardId/flag
router.patch('/:flashcardId/flag', FlashcardController.toggleFlag.bind(FlashcardController));

// DELETE /api/v1/collections/:collectionId/flashcards/:flashcardId
router.delete('/:flashcardId', FlashcardController.delete.bind(FlashcardController));
